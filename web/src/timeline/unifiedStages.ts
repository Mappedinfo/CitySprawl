...
export const UNIFIED_STAGE_DEFS: UnifiedStageDef[] = [
  ...
  {
    id: 'roads_collector',
    title: 'Major Local Roads',
    titleZh: '主支路',
    subtitle: 'Growing major local network from arterial seeds',
    subtitleZh: '从主干道种子发散生成主支路网络',
    anchor: 0.46,
    timestampMs: 9200,
    visibleLayers: ['terrain', 'rivers', 'river_areas', 'contours', 'roads', 'hubs', 'labels'],
  },
  {
    id: 'roads_local',
    title: 'Minor Local Roads',
    titleZh: '次支路',
    subtitle: 'Filling blocks with minor local network',
    subtitleZh: '在街区内填充次支路网络',
    anchor: 0.56,
    timestampMs: 11200,
    visibleLayers: ['terrain', 'rivers', 'river_areas', 'contours', 'roads', 'hubs', 'labels'],
  },
